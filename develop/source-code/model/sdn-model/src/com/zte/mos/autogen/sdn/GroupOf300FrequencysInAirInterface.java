...
@MoSet(count=300)
public class GroupOf300FrequencysInAirInterface extends GroupOf
{
    private static final long serialVersionUID = 1L;
    public GroupOf300FrequencysInAirInterface(){

    }

    public GroupOf300FrequencysInAirInterface(ManagementObject parent, String thisName){
    ...
    public com.zte.mos.message.Mo afterGet() throws MOSException
    {
        ...
        if ((getter = mos.getAfterGetter(GroupOf300FrequencysInAirInterface.class)) == null)
        {
