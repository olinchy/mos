...
import static com.googlecode.jsonrpc4j.ReflectionUtil.*;
...
public class JsonRpcServer
{
    ...
    public static final ErrorResolver DEFAULT_ERRROR_RESOLVER
            = new MultipleErrorResolver(AnnotationsErrorResolver.INSTANCE,
            ...
            throws IOException
    {
        ...
        // get node values
        String jsonRpc =
                (jsonPrcNode != null && !jsonPrcNode.isNull()) ? jsonPrcNode.asText() : "2.0";
            ...
            InvocationTargetException
    {
        ...
        {
            return (result instanceof JsonNode) ? (JsonNode) result : mapper.valueToTree(result);
        }
        else
        {
            return null;
    ...
    private MethodAndArgs findBestMethodByParamsNode(Set<Method> methods, JsonNode paramsNode)
    {
        ...
        {
            return findBestMethodUsingParamIndexes(methods, paramsNode.size(),
        ...
        else if (paramsNode.isObject())
        {
            ...
            return findBestMethodUsingParamNames(methods, fieldNames,
            ...
            Set<Method> methods, Set<String> paramNames, ObjectNode paramNodes)
    {
        ...
        for (Method method : methods)
        {
            ...
            for (int i = 0; i < annotations.size(); i++)
            {
                ...
                if (hasParamName && isMatchingType(paramNodes.get(paramName),
