        ...
        return (T) Proxy.newProxyInstance(
                ...
                new InvocationHandler()
                {
                            ...
                            throws Throwable
                    {
                        ...
                        Object arguments =
                                ReflectionUtil.parseArguments(method, args, useNamedParams);
                        return client.invokeAndReadResponse(
                                method.getName(), arguments, method.getGenericReturnType(), ops,
                                ips);
                    }
                });
    }
                ...
                new InvocationHandler()
                {
                            ...
                            throws Throwable
                    {
                        ...
                        return client.invoke(
                                method.getName(), arguments, method.getGenericReturnType(),
                                extraHeaders);
                    }
                });
    }
