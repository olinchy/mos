...
public class JsonRpcClient
{
            ...
            throws Throwable
    {
        ...
        {
            requestListener.onBeforeResponseProcessed(this, jsonObject);
        }
     ...
     * If the value passed for argument is null then the {@code params} property
     * is ommitted from the JSON-RPC request. If the argument
            ...
            throws IOException
    {
        ...
        if (arguments == null)
        {
            request.put("params", mapper.createObjectNode());
        }
        ...
        if (requestListener != null)
        {
            requestListener.onBeforeRequestSent(this, request);
        }
        if (LOGGER.isLoggable(Level.FINE))
        {
