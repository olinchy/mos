        ...
        extends JsonRpcClient
{
     ...
     * {@code serviceUrl}.
     * The headers provided in the {@code headers} map are added to every
     * request
...
//        }
    ...
    public void invokeNotification(
            ...
            throws Throwable
    {
        HttpURLConnection con = prepareConnection(new HashMap<String, String>());
        con.connect();
        ...
        try
        {
            super.invokeNotification(methodName, argument, ops);
        }
        finally
        {
            ops.close();
