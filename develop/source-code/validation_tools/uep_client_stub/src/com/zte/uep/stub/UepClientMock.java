...
import com.zte.app.common.uep.client.service.UepClientService;
...
//    }
    ...
    private void setupResourcePPUClientService(){
        ...
        UepClientService.setResourcePPUClientService(resourcePPUClientService);
    }
    ...
    private void setupResourcePPUServerService()
    {
        ...
        UepClientService.setResourcePPUServerService(resourcePPUServerService);
    }

    private void setupI18nService(){
        UepClientService.setI18nService(new I18nServiceMock());
    }

    private void setupShowMsgPaneService(){
        UepClientService.setShowMsgPaneService(new ShowMsgPaneServiceMock());
    }
    ...
    private void setupSystemSupportService(){
        ...
        UepClientService.setSystemSupportService(systemSupportServiceMock);
    }
    ...
    private void setupMainFrameService(){
        ...
        EasyMock.expectLastCall().anyTimes();
        UepClientService.setMainFrameService(mainFrameServiceMock);
    }
    ...
    private void setupFClientService(){
        ...
        EasyMock.expect(fClientServiceMock.getClientIP()).andReturn("127.0.0.1").anyTimes();
        UepClientService.setfClientService(fClientServiceMock);
    }
...
//                .andReturn(new OKPanelMock(panelMock)).anyTimes();
        UepClientService.setUiToolKitService(new UIToolkitServiceMock());
    }
    ...
    private void setupExportService(){
        UepClientService.setExportService(new ExportServiceMock());
    }
    ...
    private void setupFileTransferContextService(){
        ...
        UepClientService.setFileTransferContextService(fileTransferContextServiceMock);
    }
    ...
    private void setupFileTransferClientService(){
        UepClientService.setFileTransferClientService(new FileTransferClientServiceMock());
    }

    private void setupEmbMmlService(){
        UepClientService.setEmbMmlService(new EmbMmlServiceMock());
    }

    private void setupSystemEnvService(){
        UepClientService.setSystemEnvService(new SystemEnvServiceMock());
    }

    private void setupEmbService(){
        UepClientService.setEmbService(new EmbServiceMock());
    }

    private void setupSnmpServerService(){
        UepClientService.setSnmpServerService(new SnmpServerServiceMock());
    }

    private void setupLogClientService(){
        UepClientService.setLogClientService(new LogClientServiceMock());
    }

    private void setupImageIconService(){
        UepClientService.setImageIconService(new ImageIconServiceMock());
    }

    private void setupRolePPUClientService(){
        UepClientService.setRolePPUClientService(new RolePPUClientServiceMock());
    }
    ...
    public void setup(){
        ...
        setupLogClientService();
        setupRolePPUClientService();
        mocksControl.replay();
    }

    public void teardown(){
        UepClientService.setExportService(null);
        UepClientService.setI18nService(null);
        UepClientService.setFileTransferContextService(null);
        UepClientService.setFileTransferClientService(null);
        UepClientService.setSystemSupportService(null);
        UepClientService.setMainFrameService(null);
        UepClientService.setfClientService(null);
        UepClientService.setUiToolKitService(null);
        UepClientService.setShowMsgPaneService(null);
        UepClientService.setResourcePPUClientService(null);
        UepClientService.setResourcePPUServerService(null);
        UepClientService.setImageIconService(null);
        UepClientService.setEmbMmlService(null);
        UepClientService.setSystemEnvService(null);
        UepClientService.setEmbService(null);
        UepClientService.setSnmpServerService(null);
        UepComponent.setObject(RowNumberTable.class, null);
        UepComponent.setObject(ZXWorkSpace.class,null);
        UepClientService.setLogClientService(null);
        UepClientService.setRolePPUClientService(null);
    }
