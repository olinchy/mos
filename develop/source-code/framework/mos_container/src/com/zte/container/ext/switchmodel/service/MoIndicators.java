package com.zte.container.ext.switchmodel.service;
...
import com.zte.mos.service.indication.IndMsgCreator;
 ...
 */
public enum MoIndicators implements IndMsgCreator<Mo>
{
    Insert
            {
                @Override
                        ...
                        final String rootExternalDN) throws MOSException
                {
                    ...
                    final Mo newValue = tLog.newValue();
    ...
    Update
            {
                        ...
                        String rootExternalDN) throws MOSException
                {
                    ...
                    Mo newValue = tLog.newValue();
                    Mo oldValue = tLog.oldValue() != null ? tLog.oldValue() : null;
                    fillInRefBys(rootExternalDN, newValue);
                    newValue.setDn(new DN(dn));
    ...
    private static void fillInRefBys(final String rootExternalDN, Mo moClass)
    {
        ...
        ReferenceObject obj = ReferenceDBInBerkeley.get(
                new MOSAdaptor()
                {
                    @Override
    ...
    private static String fillDN(Mo mo, String rootExternalDN)
    {
        if (rootExternalDN.equalsIgnoreCase("/"))
            return mo.getDn().toString();
        return rootExternalDN + mo.getDn().toString();
    }
