 ...
 */
public class MOSAdaptor implements MOS
{
    @Override
    ...
    public RemovedMoInTrans deleteMoInTransaction(
            String dn, Maybe<Integer> transactionID) throws MOSException
    {
        return null;
    }
    ...
    public void updateMO(
            ManagementObject mo, Mo delta, Maybe<Integer> transactionID) throws MOSException
    {
